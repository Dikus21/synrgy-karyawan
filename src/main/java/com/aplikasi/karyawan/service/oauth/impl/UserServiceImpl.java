package com.aplikasi.karyawan.service.oauth.impl;
        ...
        try {
            ...
            if ((checkUser != null) && (encoder.matches(loginModel.getPassword(), checkUser.getPassword()))) {
                if (!checkUser.isEnabled()) {
                    ...
                    return templateResponse.errors(map);
                }
            }
            if (checkUser == null) {
                return templateResponse.errors("user not found");
            }
            if (!(encoder.matches(loginModel.getPassword(), checkUser.getPassword()))) {
                return templateResponse.errors("wrong password");
            }
...
//                userRepository.save(checkUser);
            ...
            if (e.getStatusCode() == HttpStatus.BAD_REQUEST) {
                return templateResponse.errors("invalid login : " + e.getMessage());
            }
            return templateResponse.errors(e);
        } catch (Exception e) {
            e.printStackTrace();
...
//            user.setEnabled(false); // matikan user
            ...
            return templateResponse.errors("eror:"+e);
        }
