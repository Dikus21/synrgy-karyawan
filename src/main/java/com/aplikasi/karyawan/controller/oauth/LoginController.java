...
public class LoginController {
    ...
    public ResponseEntity<Map> repairGoogleSigninAction(@RequestBody GoogleReq parameters) throws IOException {
        ...
        if (StringUtils.isEmpty(parameters.getAccessToken())) {
            return new ResponseEntity<Map>(response.errors("Token is required."), HttpStatus.OK);
        }
        ...
        try {
            ...
            return new ResponseEntity<Map>(response.errors(e.getDetails()), HttpStatus.BAD_GATEWAY);
        }
        ...
        if (null != user) {
            if (!user.isEnabled()) {
                return new ResponseEntity<Map>(response.errors("Your Account is disable. Please check your email for activation."), HttpStatus.OK);
            }
...
//                user.setPassword(oldPassword);
            ...
            return new ResponseEntity<Map>(response.errors("User is not registered please contact admin"), HttpStatus.OK);
        }
